...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer owns the backend services for the RepoForge proje… | When working in backend/ — adding, modifying, or d… | — | 542 | — | `backend/SKILL.md` |
| manage-auth-routes | This skill covers patterns for managing authentication route… | When implementing authentication features in the b… | — | 525 | — | `backend/auth/SKILL.md` |
| encrypt-api-keys | This skill covers AES-256-GCM encryption for provider API ke… | Load this skill when handling sensitive API key en… | — | 452 | — | `backend/crypto/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating OAuth states for… | Load this skill when implementing GitHub OAuth in … | — | 536 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main entry point for the appli… | — | 530 | — | `backend/main/SKILL.md` |
| add-schemas-endpoint | This skill covers the creation of Pydantic schemas for the R… | Load this skill when defining schemas for API requ… | — | 500 | — | `backend/schemas/SKILL.md` |
...
| use-auth-provider | This skill covers patterns for implementing authentication i… | Load this skill when managing user authentication | — | 486 | — | `frontend/auth/SKILL.md` |
...
| usegenerationstream-hook | This skill covers patterns for using the `useGenerationStrea… | When implementing streaming generation in the fron… | — | 512 | — | `frontend/useGenerationStream/SKILL.md` |
