...
|------|-------------|---------|------------|---------|----------|------|
| main-layer | This layer encompasses the core functionality of the project… | When working in main/ — adding, modifying, or debu… | — | 526 | — | `main/SKILL.md` |
...
| test-compressor-fixtures | This skill covers patterns for creating fixtures to test com… | Load this skill when working with the test_compres… | — | 463 | — | `main/test_compressor/SKILL.md` |
| test-plugins | This skill covers testing patterns for various repository ma… | Load this skill when working with test_plugins | — | 473 | — | `main/test_plugins/SKILL.md` |
...
| add-test-scorer-endpoint | This skill covers patterns for creating and managing test sc… | Load this skill when working with the test_scorer … | — | 405 | — | `main/test_scorer/SKILL.md` |
