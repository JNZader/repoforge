...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer provides the backend functionality for the RepoFo… | When working in backend/ — adding, modifying, or d… | — | 537 | — | `backend/SKILL.md` |
| add-auth-endpoint | This skill covers the implementation of authentication route… | When setting up auth functionality in the backend | — | 521 | — | `backend/auth/SKILL.md` |
| encrypt-api-keys | This skill covers AES-256-GCM encryption for provider API ke… | When handling sensitive crypto operations | — | 443 | — | `backend/crypto/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating GitHub OAuth sta… | Load this skill when implementing GitHub OAuth fun… | — | 479 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main entry point for the appli… | — | 500 | — | `backend/main/SKILL.md` |
| define-request-response-schemas | This skill covers the creation of Pydantic v2 request and re… | Load this skill when defining schemas for the Repo… | — | 538 | — | `backend/schemas/SKILL.md` |
| frontend-layer | This layer manages the user interface and user experience of… | When working in frontend/ — adding, modifying, or … | — | 552 | — | `frontend/SKILL.md` |
...
| add-auth-provider | This skill covers patterns for integrating authentication in… | When implementing user authentication in the appli… | — | 492 | — | `frontend/auth/SKILL.md` |
| generate-request-types | This skill covers the generation of request and response typ… | Load this skill when working with types related to… | — | 548 | — | `frontend/types/SKILL.md` |
| usegenerationstream-hook | This skill covers patterns for managing generation streams i… | Load when using `useGenerationStream` for stream m… | — | 529 | — | `frontend/useGenerationStream/SKILL.md` |
