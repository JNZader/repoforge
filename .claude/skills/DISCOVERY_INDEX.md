...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer owns the backend services for the RepoForge proje… | When working in backend/ — adding, modifying, or d… | — | 472 | — | `backend/SKILL.md` |
| add-auth-endpoint | This skill covers the implementation of authentication route… | When setting up auth-related endpoints in the back… | — | 500 | — | `backend/auth/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating OAuth states for… | Load this skill when implementing GitHub OAuth flo… | — | 511 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main entry point for the FastA… | — | 527 | — | `backend/main/SKILL.md` |
| add-schemas-endpoint | This skill covers the creation of Pydantic schemas for the R… | Load this skill when defining schemas for API requ… | — | 527 | — | `backend/schemas/SKILL.md` |
