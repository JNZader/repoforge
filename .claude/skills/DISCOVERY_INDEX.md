...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer owns the backend services for the RepoForge proje… | When working in backend/ — adding, modifying, or d… | — | 538 | — | `backend/SKILL.md` |
| add-auth-endpoint | This skill covers the implementation of authentication route… | When setting up auth-related endpoints in the back… | — | 528 | — | `backend/auth/SKILL.md` |
| encrypt-api-keys | This skill covers AES-256-GCM encryption for provider API ke… | Load this skill when handling crypto operations fo… | — | 453 | — | `backend/crypto/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating GitHub OAuth sta… | Load this skill when implementing GitHub OAuth fun… | — | 480 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main entry point for the appli… | — | 535 | — | `backend/main/SKILL.md` |
| add-schemas-endpoint | This skill covers the creation of Pydantic schemas for API r… | Load this skill when defining schemas for the Repo… | — | 512 | — | `backend/schemas/SKILL.md` |
| frontend-layer | This layer manages the user interface and client-side logic … | When working in frontend/ — adding, modifying, or … | — | 539 | — | `frontend/SKILL.md` |
...
| use-auth-provider | This skill covers patterns for implementing authentication i… | Load this skill when managing user authentication | — | 460 | — | `frontend/auth/SKILL.md` |
| generate-request-response | This skill covers the generation of requests and responses i… | Load this skill when working with types related to… | — | 501 | — | `frontend/types/SKILL.md` |
| usegenerationstream-hook | This skill covers patterns for managing generation streams i… | Load when using `useGenerationStream` for stream m… | — | 501 | — | `frontend/useGenerationStream/SKILL.md` |
