...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer owns the backend services for the RepoForge proje… | When working in backend/ — adding, modifying, or d… | — | 568 | — | `backend/SKILL.md` |
| add-auth-endpoint | This skill covers the implementation of authentication route… | When setting up auth functionality in the backend | — | 497 | — | `backend/auth/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating GitHub OAuth sta… | When implementing GitHub OAuth in your application | — | 470 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main application entry point | — | 523 | — | `backend/main/SKILL.md` |
| add-schemas-endpoint | This skill covers the creation of Pydantic schemas for the R… | Load this skill when defining schemas for API requ… | — | 520 | — | `backend/schemas/SKILL.md` |
