...
|------|-------------|---------|------------|---------|----------|------|
| backend-layer | This layer provides the FastAPI backend for the RepoForge We… | When working in backend/ — adding, modifying, or d… | — | 546 | — | `backend/SKILL.md` |
| add-auth-endpoint | This skill covers the implementation of authentication route… | When setting up auth-related endpoints in the back… | — | 533 | — | `backend/auth/SKILL.md` |
| encrypt-api-keys | This skill covers AES-256-GCM encryption for provider API ke… | Load this skill when handling crypto operations fo… | — | 455 | — | `backend/crypto/SKILL.md` |
...
| generate-github-oauth-state | This skill covers generating and validating OAuth states for… | Load this skill when implementing GitHub OAuth fun… | — | 513 | — | `backend/github_oauth/SKILL.md` |
| add-main-endpoint | This skill covers adding main endpoints to the FastAPI appli… | When setting up the main entry point for the appli… | — | 510 | — | `backend/main/SKILL.md` |
| define-request-response-schemas | This skill covers the creation of Pydantic v2 request and re… | Load this skill when defining schemas for the Repo… | — | 533 | — | `backend/schemas/SKILL.md` |
| frontend-layer | This layer manages the user interface and user experience of… | When working in frontend/ — adding, modifying, or … | — | 506 | — | `frontend/SKILL.md` |
| fetch-api-data | This skill covers patterns for fetching and managing API dat… | When working with API interactions in the frontend | — | 559 | — | `frontend/api/SKILL.md` |
| use-auth-provider | This skill covers patterns for implementing authentication i… | Load this skill when managing user authentication | — | 477 | — | `frontend/auth/SKILL.md` |
| generate-request-types | This skill covers the generation of request and response typ… | Load this skill when defining types for generation… | — | 522 | — | `frontend/types/SKILL.md` |
| usegenerationstream-hook | This skill covers the usage of the `useGenerationStream` hoo… | Load this skill when implementing streaming functi… | — | 575 | — | `frontend/useGenerationStream/SKILL.md` |
