...
|------|-------------|---------|------------|---------|----------|------|
| main-layer | This layer encompasses the core functionality of the project… | When working in main/ — adding, modifying, or debu… | — | 477 | — | `main/SKILL.md` |
...
| get-chapter-prompts | This skill covers the generation of chapter prompts for docu… | When working with docs_prompts to create structure… | — | 462 | — | `main/docs_prompts/SKILL.md` |
...
| create-test-compressor-user | This skill covers creating users for testing compression pas… | Load this skill when setting up test_compressor fi… | — | 472 | — | `main/test_compressor/SKILL.md` |
...
| add-test-scorer-endpoint | This skill covers patterns for implementing scoring function… | Load this skill when working with the test_scorer … | — | 394 | — | `main/test_scorer/SKILL.md` |
| test-security-fixtures | This skill covers patterns for testing security using crafte… | test_security | — | 408 | — | `main/test_security/SKILL.md` |
